...
require_once dirname(__FILE__) . '/controllers/front/MastercardAbstractModuleFrontController.php';
require_once dirname(__FILE__) . '/mastercard-gateway/mastercard.php';
